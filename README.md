...
├── edi_executive_infographic.html # SME data infographic
├── Dockerfile, docker-compose.yml # Container deployment (Option A below)
│
├── pages/
│   ├── Ask_EDI.py                 # Custom-decision intake form, same pipeline as the case selector
│   └── EDI_Roadmap.py             # Product roadmap page
│
├── ui/
│   └── executive_brief.py         # Shared analysis pipeline and tabbed executive-brief renderer
│
├── data/
...
│
├── engines/
│   ├── financial_engine.py        # Split NPV (forward vs total) financial analysis
...
│
├── static/
│   └── about-books.html           # About the Builder & Book List page
│
└── docs/
    ├── product-vision.md          # Product vision and core intent
    └── roadmap.md                 # Product roadmap & to-do list
```
...
make good AI decisions without becoming technical themselves. The app includes an **About the Builder & Book List** page ([`static/about-books.html`](static/about-books.html)), linked from the executive brief. More projects, including [Aegis Vector](https://github.com/ScottColeSW/Project-Aegis-Vector) and [Palimpsest](https://github.com/ScottColeSW/Palimpsest), are at
